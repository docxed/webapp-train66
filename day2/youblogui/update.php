...
<body>
    ...
    <div class="container my-5">
        <!-- Content -->
        <h2>แก้ไขโพสต์ ID : <span class="text-primary"><?php /* Code here */ ?></span></h2>
        <hr>
        <br>
        <form action="./post_actions.php" method="POST">
            <div class="mb-3">
                <label for="title" class="form-label">หัวข้อ</label>
                <input name="title" value="<?php /* Code here */ ?> type=" text" class="form-control" placeholder="หัวข้อ" maxlength="100" required />
            </div>
            <div class="mb-3">
                <label for="content" class="form-label">เนื้อหา</label>
                <textarea name="content" class="form-control" placeholder="เนื้อหา" rows="4" required<?php /* Code here */ ?></textarea>
            </div>
            <!-- ส่ง postId ไปด้วย (type hidden คือ ประเภทที่ซ่อนไว้) -->
            <input type="hidden" name="postId" value="<?php /* Code here */ ?>">
